                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="right" class="es-infoblock es-m-txt-c"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:14px;color:#CCCCCC">
                                                                        <a href="https://162.214.118.68" target="_blank"
                                                                            class="view"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:12px;text-decoration:none;color:#CCCCCC">Abrir
                                                                            en el navegador</a></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td bgcolor="#fcfcfc" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hola&nbsp;{{ $user['name'] }}!
                                                                        Gracias por usar StudyCuci!&nbsp;<br>Esperamos
                                                                        poder ayudarte a encontrar los mejores
                                                                        restaurantes y hogares para ti.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <h3
                                                                        ...
                                                                        Gracias por usar la plataforma</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
